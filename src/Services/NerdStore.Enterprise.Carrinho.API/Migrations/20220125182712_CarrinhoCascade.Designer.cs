...
namespace NerdStore.Enterprise.Carrinho.API.Migrations
{
    ...
    [Migration("20220125182712_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NerdStore.Enterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NerdStore.Enterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NerdStore.Enterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("NerdStore.Enterprise.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("NerdStore.Enterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("NerdStore.Enterprise.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
